function [ res ] = cnn_test_bbox_regressor_GPU( conf, imdb, rcnn_model, bbox_reg, suffix, fid )
% conf = rcnn_config('sub_dir', imdb.name);
fprintf('cnn_test_bbox_regressor_GPU function');
image_ids = imdb.image_ids;
conf.cache_dir = 'cachedir/voc_2007_test_FALKON_GPU/';
