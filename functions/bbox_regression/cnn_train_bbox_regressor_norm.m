function bbox_reg = cnn_train_bbox_regressor_norm(conf, imdb, roidb, cnn_model, bbox_model_suffix, varargin)
...
% caffe_net=[];
[opts.mean_norm, opts.standard_deviation, opts.mean_feat] = extract_feature_statistics(imdb, opts.layer, cnn_model);
% opts.feat_norm_mean = rcnn_feature_stats(imdb, opts.layer, cnn_model);
% %OK (imdb, layer, rcnn_model)
