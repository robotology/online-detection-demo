...
function script_faster_rcnn_VOC2007_ZF_finetune_TASK1()
...
opts.do_val                 = false; 
% model
model                       = Model.ZF_for_Faster_RCNN_VOCreduced_finetune;
% cache base
...
removed_classes_T1 =  {'cat','chair','cow','diningtable','dog','horse','motorbike','person','pottedplant','sheep','sofa','train','tvmonitor'};
...
dataset.TASK1                     = Dataset.voc2007_train(dataset.TASK1, 'trainval', use_flipped, removed_classes_T1, imdb_cache_name);
dataset.TASK1                     = Dataset.voc2007_test(dataset.TASK1, 'test', false, removed_classes_T1, imdb_cache_name);
output_dir                        = 'output_VOC2007_finetune_voc_reduced_time';
...
save('workspaces/ZF_voc2007_finetune_on_vocreduced');
...
save('workspaces/ZF_voc2007_fietune_on_vocreduced');
