...
TASK2_proposals_suffix = '_TASK2_10objs_single';  %---------------------------------------------------------------------------------------------
...
results_dir = ['results_vocFeatures_FALKON_iCWT_' int2str(bkg_numb) 'bkg_for_TASK2_10objs_single/']; %----------------------------------------------------------------
results_file_name = ['results.txt']; %unused
imdb_val_cache_name = imdb_cache_name; %-------------------------------------------------------------------------------------------

boxes_dir = ['cachedir/iCWT_test_FALKON_' int2str(bkg_numb) 'bkg_TASK2_10objs_TASK1Features_single/']; %------------------------------------------------------------------
