...
results_dir = ['results_40k20k_FALKON_voc2007_lightCV_improved/']; %----------------------------------------------------------------
results_file_name = ['lightCV_imporved_results.txt']; %-----------------------------------------------------------------------------
imdb_val_cache_name = 'cache_full_Pascal07';

boxes_dir = ['cachedir/voc_2007_test_FALKON_lightCV_improved/']; %------------------------------------------------------------------
bbox_model_suffix = '_full_norm'; %---------------------------------------------------------------------------------------
