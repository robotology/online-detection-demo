...
TASK2_proposals_suffix = '_TASK2_10objs_voc_features_bootStrap_more';  %---------------------------------------------------------------------------------------------
...
results_dir = ['results_vocFeatures_FALKON_iCWT_TASK2_10objs_minibootStrap_more_iters/']; %----------------------------------------------------------------
results_file_name = ['results.txt']; %unused
imdb_val_cache_name = imdb_cache_name; %-------------------------------------------------------------------------------------------

boxes_dir = ['cachedir/iCWT_test_FALKON_bkg_TASK2_10objs_vocFeatures_minibootStrap_more_iters/']; %------------------------------------------------------------------
