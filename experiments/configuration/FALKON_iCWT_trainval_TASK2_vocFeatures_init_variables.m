...
load('workspaces/VOC2007_full_trained_ZF_80k60k_new');  %---------------------------------------------------------------------------------------------
...
TASK2_proposals_suffix = '_TASK2_10objs_voc_features';  %---------------------------------------------------------------------------------------------
...
model.feature_extraction.cache_name = 'vocFeatures_iCWT_for_TASK2_10objs'; %-----------------------------------------------------
...
results_dir = ['results_vocFeatures_FALKON_iCWT_' int2str(bkg_numbs) 'bkg_for_TASK2_10objs/']; %----------------------------------------------------------------
results_file_name = ['results.txt']; %unused
imdb_val_cache_name = imdb_cache_name; %-------------------------------------------------------------------------------------------

boxes_dir = ['cachedir/iCWT_test_FALKON_' int2str(bkg_numbs) 'bkg_TASK2_10objs_vocFeatures/']; %------------------------------------------------------------------
