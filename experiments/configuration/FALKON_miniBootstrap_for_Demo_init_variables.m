...
imdb_cache_name    = 'cache_dump_for_exp_demo_5objs'; %---------------------------------------------------------------------------------------------
...
TASK2_proposals_suffix = '_TASK2_exp_for_demo_new';  %---------------------------------------------------------------------------------------------
...
model.stage2_rpn.cache_name = [cnn_model_dir '/cache_rpn'];
...
model.feature_extraction.cache_name        = 'VOCfeatures_for_exp_demo_5objs'; %-----------------------------------------------------
...
results_dir         = ['results_vocFeatures_FALKON_for_exp_demo_5objs/']; %---------------
results_file_name   = ['results.txt'];       %unused
imdb_val_cache_name = imdb_cache_name;       %------------------------------------------------------------------

boxes_dir           = ['cachedir/test_icwt/'];    %-----------------------------------------------------------------
bbox_model_suffix   = '_for_exp_demo_5objs'; %-----------------------------------------------------------------
