...
results_dir = ['results_40k20k_FALKON_voc2007_validation_trainvalTest_jointExp/']; %----------------------------------------------------------------
results_file_name = ['results.txt'];

boxes_dir = ['cachedir/voc_2007_test_FALKON_validation_trainvalTest_jointExp/']; %------------------------------------------------------------------
bbox_model_suffix = '_full_trainvalTest_validation_jointExp'; %---------------------------------------------------------------------------------------
reg_mode = 'no_norm';
