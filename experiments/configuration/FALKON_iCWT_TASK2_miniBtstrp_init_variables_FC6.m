...
TASK2_proposals_suffix = '_TASK2_10objs_voc_features_bootStrap_fc6features';  %---------------------------------------------------------------------------------------------
...
model.feature_extraction.cache_name = 'TASK1Features_iCWT_for_TASK2_10objs_fc6features'; %-----------------------------------------------------
...
results_dir = ['results_vocFeatures_FALKON_iCWT_bkg_for_TASK2_10objs_minibootStrap_fc6features/']; %----------------------------------------------------------------
results_file_name = ['results.txt']; %unused
imdb_val_cache_name = imdb_cache_name; %-------------------------------------------------------------------------------------------

boxes_dir = ['cachedir/iCWT_test_FALKON_bkg_TASK2_10objs_vocFeatures_minibootStrap_fc6features/']; %------------------------------------------------------------------
bbox_model_suffix = '_TASK2_10objs_fc6features'; %---------------------------------------------------------------------------------------
...
cls_mode = 'rls_falkon_miniBootstrap'; %---------------------------------------------------------------------------------------------
