...
results_dir = ['results_40k20k_FALKON_voc2007_mean_subtraction/']; %----------------------------------------------------------------
results_file_name = ['results.txt'];

boxes_dir = ['cachedir/voc_2007_test_FALKON_mean_subtraction/']; %------------------------------------------------------------------
...
model.stage2_rpn.nms.after_nms_topN = 300;
