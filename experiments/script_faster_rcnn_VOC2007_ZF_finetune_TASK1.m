...
opts.do_val                 = false; 
% model
model                       = Model.ZF_for_Faster_RCNN_VOC2007_finetune_TASK1;
% cache base
...
removed_classes_T1 = {'diningtable','dog','horse','motorbike','person','pottedplant','sheep','sofa','train','tvmonitor'};
...
dataset.TASK1                     = Dataset.voc2007_train(dataset.TASK1, 'train', use_flipped, removed_classes_T1, imdb_cache_name);
dataset.TASK1                     = Dataset.voc2007_test(dataset.TASK1, 'test', false, removed_classes_T1, imdb_cache_name);
output_dir                        = 'output_VOC2007_finetune_TASK1';
...
save('workspaces/ZF_voc2007_finetune_TASK1_on_TASK1');
...
save('workspaces/ZF_voc2007_finetune_TASK1');
