function model = ZF_for_Faster_RCNN_VOC2007_reduced(model)
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'ZF', 'solver_15k20k.prototxt');
...
model.stage2_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'ZF_fc6', 'solver_15k20k.prototxt');
