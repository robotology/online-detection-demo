function model = ZF_for_Faster_RCNN_ICUB_10objs(model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models10', 'rpn_prototxts', 'ZF', 'solver_30k40k.prototxt');
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models10', 'fast_rcnn_prototxts', 'ZF', 'solver_20k15k.prototxt');
...
model.stage2_fast_rcnn.solver_def_file          = fullfile(pwd, 'models10', 'fast_rcnn_prototxts', 'ZF_fc6', 'solver_15k20k.prototxt');
model.stage2_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models10', 'fast_rcnn_prototxts', 'ZF_fc6', 'test.prototxt');
