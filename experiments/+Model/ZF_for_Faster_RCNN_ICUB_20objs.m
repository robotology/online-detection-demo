function model = ZF_for_Faster_RCNN_ICUB_20objs(model)

% model.mean_image                                = fullfile(pwd, 'models10', 'pre_trained_models', 'ZF', 'mean_image');
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF', 'solver_30k40k.prototxt');
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF', 'test.prototxt');
...
model.stage2_fast_rcnn.solver_def_file          = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF_fc6', 'solver_30k40k.prototxt');
model.stage2_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF_fc6', 'test.prototxt');
