...
%% stage 3 fast rcnn, only finetune fc layers
model.stage3_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'ZF_det', 'solver_6k.prototxt');
model.stage3_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', 'fast_rcnn_prototxts', 'ZF_det', 'test.prototxt');
