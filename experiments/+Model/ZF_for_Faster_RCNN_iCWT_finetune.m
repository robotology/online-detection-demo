...
model.stage2_rpn.solver_def_file                = fullfile(pwd, 'models20', 'rpn_prototxts', 'ZF_fc6', 'solver_160k110k.prototxt');
model.stage2_rpn.test_net_def_file              = fullfile(pwd, 'models20', 'rpn_prototxts', 'ZF_fc6', 'test.prototxt');
model.stage2_rpn.output_model_file              = fullfile(pwd, 'output_VOC2007train_ZF_40k20k/rpn_cachedir/faster_rcnn_VOC2007_ZF_top-1_nms0_7_top2000_stage2_rpn/voc_2007_train', 'final');
...
model.stage2_fast_rcnn.solver_def_file          = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF_fc6', 'solver_full_finetune.prototxt');
model.stage2_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF_fc6', 'test_full.prototxt');
model.stage2_fast_rcnn.init_net_file            = fullfile(pwd, 'output_VOC2007train_ZF_40k20k/fast_rcnn_cachedir/faster_rcnn_VOC2007_ZF_top-1_nms0_7_top2000_stage2_fast_rcnn/voc_2007_train', 'final');
%% final test
