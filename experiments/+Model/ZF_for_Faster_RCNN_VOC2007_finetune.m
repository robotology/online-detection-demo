...
model.stage2_fast_rcnn.solver_def_file          = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF_fc6', 'solver_15k20k_finetune.prototxt');
model.stage2_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models20', 'fast_rcnn_prototxts', 'ZF_fc6', 'test_finetune.prototxt');
