function script_faster_rcnn_decomposed_ICUB_ZF()
...
train_classifier_options.cache_dir = 'cache_classifiers/gurls_VOC2007_gt_gauss_voc_mean_19objs/';
...
opts.cls_mAP                = cellfun(@(x) Incremental_Faster_RCNN_Train.do_classifiers_test(train_classifier_options.cache_dir, conf_fast_rcnn, '',  'gurls',  model.classifiers, x), dataset.imdb_test, 'UniformOutput', false);
