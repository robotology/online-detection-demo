function script_multiple_rls_voc2007_reduced_ZF_GPU(bkg_numbs)

FALKON_GPU_init_variables;
...
%                 fprintf( fid, 'alpha = %f \n', rebal_alpha);
                ...
                % train classifiers
                model.classifiers.falkon = cellfun(@(x) Incremental_Faster_RCNN_Train.do_classifier_train_GPU(conf_fast_rcnn, model.feature_extraction, cls_mode, ...
                ...
                rmdir('cachedir/voc_2007_test_FALKON_GPU','s');
                mkdir 'cachedir/voc_2007_test_FALKON_GPU/';

                % test classifiers
                res_cls = cellfun(@(x) Incremental_Faster_RCNN_Train.do_classifiers_test_GPU(train_classifier_options.cache_dir, conf_fast_rcnn, '',  cls_mode, ...
                ...
                % test regressors
                res_reg = cellfun(@(x) Incremental_Faster_RCNN_Train.do_regressor_test_GPU(conf_fast_rcnn, model.bbox_regressors.bbox_reg, model.feature_extraction, x, fid), ...
