function script_FALKON_on_iCWT_TASK2_7000_vocFeatures(bkg_numbs, sigmas, lambdas, nyst_centres, iterations, gpu_id)
...
FALKON_iCWT_trainval_TASK2_vocFeatures_init_variables;
