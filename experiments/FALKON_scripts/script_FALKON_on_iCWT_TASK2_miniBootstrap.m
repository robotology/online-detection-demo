function script_FALKON_on_iCWT_TASK2_miniBootstrap(bkg_numbs, sigmas, lambdas, nyst_centres, iterations, gpu_id)

gpuDevice(gpu_id);

FALKON_iCWT_TASK2_miniBootstrap_init_variables;
