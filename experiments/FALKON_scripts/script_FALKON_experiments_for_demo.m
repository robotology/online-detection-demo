function script_FALKON_experiments_for_demo(cnn_model_dir, sigmas, lambdas, nyst_centres, reg_after_nms, gpu_id)

gpuDevice(gpu_id);

FALKON_miniBootstrap_for_Demo_init_variables;
