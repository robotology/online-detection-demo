...
%imdb.name = ''
%imdb.image_dir = '/work4/rbg/ICUB2007/ICUBdevkit/Images/' %ELISA todo
%imdb.extension = '.jpg'
...
try
  ...
  for i = 1:length(imdb.image_ids)
    ...
    info = imfinfo(sprintf(ICUBopts.imgpath, imdb.image_ids{i}));
