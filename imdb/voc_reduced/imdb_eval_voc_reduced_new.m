function res = imdb_eval_voc_reduced_new(cls, boxes, imdb, cache_name, suffix)
...
if do_eval
  ...
  tic;
  [recall, prec, ap] = VOCevaldet_reduced(VOCopts, res_id, cls, draw_curve,imdb.removed_classes);
