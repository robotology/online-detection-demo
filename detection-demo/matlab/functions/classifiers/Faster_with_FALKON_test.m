function [ res ] = Faster_with_FALKON_test( rcnn_model, config, imdb, suffix, fid )
...
%          fprintf('other stuff during test tic %f\n', toc(other_tic))
      end
%       fprintf('all classes test tic %f\n', toc(all_classes_tic))
    end
  end
